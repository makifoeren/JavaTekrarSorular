...
public class Q6_StringManipulation {
	 ...
	 */
       ...
       String isim=scan.nextLine();
        ...
        System.out.print("Lütfen soyisiminiz giriniz : ");
        String soyisim=scan.nextLine();

       System.out.print("Lütfen 16 haneli kart numarasinigiriniz : ");
       ...
       if (kartNo.length()>= 16) {
           ...
           System.out.println("Kart sahibinin ismi = " + isim + "\nKart sahibinin soyismi = " + soyisim + "\nKart no = " + kartNo);

       }else System.out.println("Kartiniz 16 haneli olarak giriniz");
