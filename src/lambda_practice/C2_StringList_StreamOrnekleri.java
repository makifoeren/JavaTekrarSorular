...
public class C2_StringList_StreamOrnekleri {
    public static void main(String[] args) {
        ...
        System.out.println("dcIleBAslayan(liste) = " + dcIleBAslayan(list));
        yildizliYaz(list);
        System.out.println("alfabedik(list) = " + alfabedik(list));
        lLeriSil(list);
        System.out.println("eOlanlar(list) = " + eOlanlar(list));
        ilkHarf3KereYaz(list);
        ilkByuksonraKck(list);
        System.out.println("dortve6olanHAric(list) = " + dortve6olanHAric(list));


    }
    // S1: ilk harfi d ve ya c olanlari listeleyelim

    public static List<String> dcIleBAslayan(List<String> l) {
    ...
    public static  List<String> eOlanlar(List<String> l) {
        System.out.println();
        ...
        public static void ilkHarf3KereYaz(List<String> l) {
            System.out.println();
            l.stream().map(t-> t.substring(0,1).toUpperCase()+t.substring(0,1).toLowerCase()+t.substring(0).toLowerCase()).
                    forEach(t-> System.out.println(t+" "));
        }

    // S7: tum elemanlarin ilk harfini buyuk digerlerini kucuk yaziniz
    public static void ilkByuksonraKck(List<String> l) {
        System.out.println();
    ...
    public static  List<String> dortve6olanHAric(List<String> l) {
        System.out.println();
