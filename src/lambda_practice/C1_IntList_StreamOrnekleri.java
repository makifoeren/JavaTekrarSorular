...
public class C1_IntList_StreamOrnekleri {
    public static void main(String[] args) {
        ...
        hepsiniYaz(list);
        nagatifleriYaz(list);
        System.out.println("pozitif list : " + pozitifList(list));
        System.out.println("karekeri list : " + kareleriList(list));
        System.out.println("kareleriTekrarsiz list : " + kareleriTekrarsizList(list));
        sirala(list);
        byktnkcgesirala(list);
        System.out.println("kuplerin listesi : " + kuplerlist(list));
        System.out.println("kareleri5Degillist(list) = " + kareleri5Degillist(list));
        System.out.println("toplam(list) = " + toplam(list));
        System.out.println("negatiflerinkareleri(list) = " + negatiflerinkareleri(list));
        System.out.println("bestenBuyukVarmi(list) = " + bestenBuyukVarmi(list));
        System.out.println("sifrdanKucukMu(list) = " + sifrdanKucukMu(list));
    ...
    public static void nagatifleriYaz(List<Integer> l) {
        System.out.println();
    ...
    public static void byktnkcgesirala(List<Integer> l) {
        System.out.println();
    ...
    public static List<Integer> kareleri5Degillist(List<Integer> l) {
        System.out.println();
        return l.stream().filter(t -> t > 0).map(t -> t * t).filter(t -> t % 10 != 5).collect(Collectors.toList());
// map ara islem reduce terminal islem
    }
    ...
    public static boolean sifrdanKucukMu(List<Integer> l) {
...
//limit reduce
    //l.stream().skip(l.size()-5).peek(t-> System.out.print(t+ " ")).reduce(0,Integer::sum);
